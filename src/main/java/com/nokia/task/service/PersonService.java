...
public class PersonService {
    ...
    public List<Person> findByName(String name){
        return persons.stream().filter(x-> x.getName().equals(name)).collect(Collectors.toList());
    }
    ...
    public boolean addPerson(Person person){
        ...
        boolean isExists= persons.stream().filter(x-> x.getId().equals(person.getId())).findFirst().isPresent();
